...
$film = query("SELECT * FROM film ORDER BY id ASC LIMIT $awalData, $jumlahDataPerHalaman");
...
mysqli_query($konek, "INSERT INTO film VALUES ('','$judul','$genre','$durasi','$direktur','$casts','$foto','$trailer','$sinopsis','$waktu','$harga')");
...
<center>
<div id="container">
<h1 class="jdl-movies"> ADD FILM</h1><br>
...
<tr><td style="width: 10%;background: #0e037a;border-radius: 3px;"><label style="color:white;" for="judul"><?= ucwords('judul'); ?></label></td><td style="width: 1%">:</td>
	<td style="width: 70%;"><input autocomplete="off" autofocus type="text" name="judul" id="judul" placeholder="judul film"></td></tr>
<tr><td style="width: 10%;background: #0e037a;border-radius: 3px;"><label style="color:white;" for="genre"><?= ucwords('genre'); ?></label></td><td style="width: 1%">:</td>
	<td style="width: 70%;"><input autocomplete="off" type="text" name="genre" id="genre" placeholder="genre film"></td></tr>
<tr><td style="width: 10%;background: #0e037a;border-radius: 3px;"><label style="color:white;" for="durasi"><?= ucwords('durasi'); ?></label></td><td style="width: 1%">:</td>
	<td style="width: 70%;"><input autocomplete="off" type="text" name="durasi" id="durasi" placeholder="durasi film"></td></tr>
<tr><td style="width: 10%;background: #0e037a;border-radius: 3px;"><label style="color:white;" for="direktur"><?= ucwords('direktur'); ?></label></td><td style="width: 1%">:</td>
	<td style="width: 70%;"><input autocomplete="off" type="text" name="direktur" id="direktur" placeholder="direktur film"></td></tr>
<tr><td style="width: 10%;background: #0e037a;border-radius: 3px;"><label style="color:white;" for="casts"><?= ucwords('casts'); ?></label></td><td style="width: 1%">:</td>
	<td style="width: 70%;"><input autocomplete="off" type="text" name="casts" id="casts" placeholder="casts film"></td></tr>
<tr><td style="width: 10%;background: #0e037a;border-radius: 3px;"><label style="color:white;" for="foto"><?= ucwords('foto'); ?></label></td><td style="width: 1%">:</td>
	<td style="width: 70%;"><input autocomplete="off" type="file" name="foto" id="foto" placeholder="foto film"></td></tr>
<tr><td style="width: 10%;background: #0e037a;border-radius: 3px;"><label style="color:white;" for="trailer"><?= ucwords('trailer'); ?></label></td><td style="width: 1%">:</td>
	<td style="width: 70%;"><input autocomplete="off" type="file" name="trailer" id="trailer" placeholder="trailer film"></td></tr>
<tr><td style="width: 10%;background: #0e037a;border-radius: 3px;"><label style="color:white;" for="sinopsis"><?= ucwords('sinopsis'); ?></label></td><td style="width: 1%">:</td>
	<td style="width: 70%;"><input autocomplete="off" type="text" name="sinopsis" id="sinopsis" placeholder="sinopsis film"></td></tr>
<tr><td style="width: 10%;background: #0e037a;border-radius: 3px;"><label style="color:white;" for="waktu"><?= ucwords('waktu'); ?></label></td><td style="width: 1%">:</td>
	<td style="width: 70%;"><input autocomplete="off" type="text" name="waktu" id="waktu" placeholder="waktu tayang, batasi pakai koma, misal : 10:00,19:00,14:00 minimal 3 waktu"></td></tr>
<tr><td style="width: 10%;background: #0e037a;border-radius: 3px;"><label style="color:white;" for="harga"><?= ucwords('harga'); ?></label></td><td style="width: 1%">:</td>
	<td style="width: 70%;"><input autocomplete="off" type="text" name="harga" id="harga" placeholder="harga tiket pakai titik misal, 45.000"></td></tr>
<tr><td colspan="3">
	<button type="submit" id="tambahfilm" name="tambahfilm">Tambah</button>
</td></tr>
</table>
</form>
<br>
