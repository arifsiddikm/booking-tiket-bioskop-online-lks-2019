...
$orders = query("SELECT * FROM pesanan ORDER BY id ASC LIMIT $awalData, $jumlahDataPerHalaman");
...
<table class="orders">
	...
	<tr>
		...
		<td>
			...
			<a class="vt" href="" onclick="alert('fitur ini tidak berfungsi');">Update</a>
			<a class="vt" href="delorder.php?id=<?= $o['id']; ?>" onclick="return confirm('Hapus Tiket Film <?= ucwords($o['film']); ?>?');">Delete</a>
		</td>
	</tr>
	<?php endforeach; ?>
</table>
